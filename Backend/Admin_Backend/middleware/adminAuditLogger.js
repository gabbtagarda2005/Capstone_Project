...
const AUTH_SKIP_PREFIXES = [
  ...
  "/api/auth/operator-forgot-password",
  "/api/auth/operator-forgot-password-otp",
  "/api/auth/operator-verify-reset-otp",
  "/api/auth/operator-reset-password-token",
  "/api/auth/operator-reset-password",
