 ...
 * No coordinates stored — only coverageId counters for planning. Same collection as
 * PassengerTerminalAffinityRead (kept as a separate model name — mongoose allows multiple models
 * on one collection as long as names differ).
 */
